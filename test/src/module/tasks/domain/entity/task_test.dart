...
void main() {
  group('Task', () {
    test('creates a Task instance with all properties', () {
      ...
      expect(task.state, TaskState.inProgress);
    ...
    test('checkboxState returns correct state based on TaskState', () {
      const todoTask = Task(name: 'Todo Task', state: TaskState.todo);
      const inProgressTask = Task(name: 'In Progress Task', state: TaskState.inProgress);
      const completedTask = Task(name: 'Completed Task', state: TaskState.done);
    ...
    test('toString returns correct string representation', () {
      ...
      expect(task.toString(),
          'Task(id: 1, name: Test Task, state: TaskState.inProgress, project: Project(id: p1, name: Project 1), context: Context(id: c1, name: Context 1), createdAt: 2023-01-01 00:00:00.000, dueDate: 2023-01-02 00:00:00.000)');
    });
  });
